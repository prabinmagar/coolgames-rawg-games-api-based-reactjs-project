...
const genreSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(fetchAsyncGenres.pending, (state, action) => {
        ...
        builder.addCase(fetchAsyncGenres.rejected, (state, action) => {
...
export const selectAllGenresStatus = (state) => state.genres.genresStatus;
