...
const storeSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(fetchAsyncStores.pending, (state, action) => {
        ...
        builder.addCase(fetchAsyncStores.rejected, (state, action) => {
            state.storesStatus = STATUS.FAILED;
        })

        builder.addCase(fetchAsyncStoresDetails.pending, (state, action) => {
        ...
        builder.addCase(fetchAsyncStoresDetails.rejected, (state, action) => {
