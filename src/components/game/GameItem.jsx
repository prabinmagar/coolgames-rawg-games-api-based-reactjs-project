  ...
  return (
    <GameItemWrapper className='card'>
      <div className='card-top img-fit-cover'>
        ...
        <div className='ratings-count'>{ gameItem?.ratings_count} <BsStar className='ms-1' size = {12} /> </div>
      </div>
      <div className='card-bottom'>
        <h4 className='text-white text-uppercase card-title'>{gameItem?.name}</h4>
        <p className='para-text'>Minecraft Legends, a real-time strategy action ... </p>
