    ...
    <FooterWrapper>
      <div className='footer-top'>
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            ...
            <p className='para-text'>Lorem ipsum dolor sitamet consectur adipiscing Duis esollici tudin augue euismod. Nulla ullam dolor sitamet consectetur</p>
          </div>
      ...
      <div className='footer-bottom'>
        <div className='container d-flex flex-column text-center'>
          <p className='footer-bottom-text text-green'>Copyright © 2023 GeekProbin - All rights reserved.</p>
