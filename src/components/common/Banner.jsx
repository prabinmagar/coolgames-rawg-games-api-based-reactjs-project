  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        ...
        <p className='lead-text'>Live gaming with lots of other games ipsum dolor sit amet, consectetur adipiscing elit. Donec malesuadalorem maximus mauris scelerisque, at rutrum nulla dictum. Ut ac ligula sapien.</p>
