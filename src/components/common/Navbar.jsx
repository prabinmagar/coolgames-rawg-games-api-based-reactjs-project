          ...
          <div className = {`navbar-collapse ${sidebarStatus ? 'show' : ""}`}>
            ...
            <ul className='connect-list d-flex justify-content-center align-items-center mt-5 flex-wrap'>
              ...
              <li className='connect-item'>
                <Link to = "/" className='connect-link'><BsRssFill /></Link>
              </li>
              <li className='connect-item'>
                <Link to = "/" className='connect-link'><BsSteam size = { 18 } /></Link>
              </li>
              <li className='connect-item'>
                <Link to = "/" className='connect-link'><BsTwitch size = { 18 } /></Link>
              </li>
              <li className='connect-item'>
                <Link to = "/" className='connect-link'><BsYoutube size = {  19 } /></Link>
              </li>
            </ul>
          </div>
        </div>
